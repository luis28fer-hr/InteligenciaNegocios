...
@section('plantilla')
    ...
    <div class="section">
        ...
        <br>
        <hr>
        <button id="agregar-card">
            <div><i class="fa-solid fa-plus"></i></div>Nueva cuenta
        </button>
        <div id="card-container" class="contenedor-cuentasT">
        ...
        <button id="balanceG">
            <div><i class="fa-solid fa-repeat"></i></div>Generar
        </button>
        {{-- ACTIVOS --}}
        ...
        <div class="tables-container">
            ...
            <table id="circulantes-A">
                <thead>
                    <tr class="tema">
                        <th colspan="2">Circulantes</th>
                    </tr>
                    <tr class="tema titulos">
                        <th>Título</th>
                        <th>Cantidad</th>
                    </tr>
                </thead>
        ...
        <div>
            <button id="add-row-btn">
                <div><i class="fa-solid fa-plus"></i></div>Agregar fila
            </button>
            <table id="movimientos-table">
                ...
                <tfoot>
                    <tr class="total-row tema titulos">
                        <td>Total:</td>
            ...
            <script>
                document.getElementById('add-row-btn').addEventListener('click', function() {
                    ...
                    newRow.innerHTML = `
            <td contenteditable="true" class="tdclass"></td>
            <td contenteditable="true" class="tdclass"></td>
            <td contenteditable="true" class="tdclass"></td>
            <td contenteditable="true" class="tdclass"></td>
            <td contenteditable="true" class="tdclass"></td>
